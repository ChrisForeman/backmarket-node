...
class BackMarketAPI {
    ...
    updateOrderLine(orderLineId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            yield axios.default.post(`${this.rootEndpoint}/ws/orderlines/${orderLineId}`, data, { headers: this.headers });
        });
    }
    getOrder(orderId) {
        return axios.default.get(`${this.rootEndpoint}/ws/order/${orderId}`, { headers: this.headers }).then(res => {
